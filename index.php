<?php
    ...
    if(isset($_POST['login-btn']))
    {
        ...
        if($user_present > 0)
        {
            ...
            $_SESSION['current_email'] = $user_data['email'];
            $_SESSION['current_account_type'] = $user_data['account_type'];
            
            
            echo "<script>
            var alerttxt = 'Successfully logged in.';
    ...
    if(isset($_POST['register-btn']))
    {
        ...
        if($password == $confirm_password)
        {
            ...
            {
                $sql = "INSERT INTO user(firstname,lastname, email, password, account_type, gender,age) VALUES('$firstname', '$lastname', '$email', '$password', 'user', '$gender', '$age')";
                ...
                if($mysql_conn)
                {
                    ...
                    echo "<script>
                    window.alert('$email is now registered.');
		...
		<div style="max-width: 400px;"><br>
            <form method="POST">
      			<div class="input-group has-color" style="padding-bottom: 2%; width: 300px;">
            		...
            		<input type="text" class="form-control" name="email" style="font-size: 12px" id="user-login" placeholder="Email" required>
      			</div>
      			<div class="input-group has-color" style="padding-bottom: 2%; width: 300px;">
            		<span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
            		<input class="form-control" type="password" name="password" style="font-size: 12px" id="pass-login" placeholder="Password" required>
     			</div>
     			<input type="submit" class="btn btn-info" value="Login" id="login-button" name="login-btn" style="width: 40%; background-color:#105285;"><br><br>
    ...
    <div data-role="main" class="ui-content">
        ...
        <div style="max-width: 400px;"><br>
            <form method="POST">
                ...
                <div class="input-group has-color" style="padding-bottom: 2%; width: 300px;">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                    <input type="text" class="form-control" style="font-size: 12px" name="firstname" id="user-fname" placeholder="First Name" required >
                </div>
                <div class="input-group has-color" style="padding-bottom: 2%; width: 300px;">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                    <input type="text" class="form-control" style="font-size: 12px" name="lastname" id="user-lname" placeholder="Last Name" required>
                </div>
                <div class="input-group has-color" style="padding-bottom: 2%; width: 300px;">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
                    <input class="form-control" type="email" style="font-size: 12px" name="email" id="email" placeholder="Email" required>
                </div>
                <div class="input-group has-color" style="padding-bottom: 2%; width: 300px;">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                    <select class="form-control" name="gender" placeholder="Gender" style="font-size: 12px"  required>
                ...
                <div class="input-group has-color" style="padding-bottom: 2%; width: 300px;">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                    <input type="text" class="form-control" style="font-size: 12px" name="age" id="user-age" placeholder="Age" required>
                </div>
                <div class="input-group has-color" style="padding-bottom: 2%; width: 300px;">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                    <input class="form-control" type="password" style="font-size: 12px" name="password"id="pass-reg" placeholder="Password" required>
                </div>
                <div class="input-group has-color" style="padding-bottom: 2%; width: 300px;">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                    <input class="form-control" type="password" style="font-size: 12px" name="confirm_password" id="cpass-reg" placeholder="Confirm Password" required>
                </div>
                ...
                <input type="submit" class="btn btn-info" value="Register" style="width: 40%; background-color:#105285;" name="register-btn" id="register-button"><br><br>
             </form>
